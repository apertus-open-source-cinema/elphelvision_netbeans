...
public class SettingsLayout extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        Amax = new elphelvision.EButton();
        Cimax = new elphelvision.EButton();
        FullHD = new elphelvision.EButton();
        SmallHD = new elphelvision.EButton();
        Custom = new elphelvision.EButton();
        ColorModePanel = new javax.swing.JPanel();
        jLabel2 = new javax.swing.JLabel();
        color_rbg = new elphelvision.EButton();
        color_jp4 = new elphelvision.EButton();
        FPSPanel = new javax.swing.JPanel();
        jLabel3 = new javax.swing.JLabel();
        fps24 = new elphelvision.EButton();
        fps25 = new elphelvision.EButton();
        fps30 = new elphelvision.EButton();
        fps50 = new elphelvision.EButton();
        fps60 = new elphelvision.EButton();
        fpscustom = new elphelvision.EButton();
        JPEGQualityPanel = new javax.swing.JPanel();
        JPEG_Plus = new elphelvision.EButton();
        JPEGQualityButton = new elphelvision.EButton();
        JPEG_Minus = new elphelvision.EButton();
        NavigationPanel = new javax.swing.JPanel();
        SettingsMenu1Button = new elphelvision.EButton();
        SettingsMenu2Button = new elphelvision.EButton();
        ConfirmationPanel = new javax.swing.JPanel();
        SettingsOKButton1 = new elphelvision.EButton();
        SettingsCancelButton = new elphelvision.EButton();
        WBPanel = new javax.swing.JPanel();
        jLabel4 = new javax.swing.JLabel();
        WBTungsten = new elphelvision.EButton();
        WBDaylight = new elphelvision.EButton();
        WBFlourescent = new elphelvision.EButton();
        WBAuto = new elphelvision.EButton();
        WBCloudy = new elphelvision.EButton();
        WBCustom = new elphelvision.EButton();
        RecordFormatPanel = new javax.swing.JPanel();
        FormatQuicktime = new elphelvision.EButton();
        jLabel5 = new javax.swing.JLabel();
        FormatJPEGs = new elphelvision.EButton();
    ...
    private elphelvision.EButton Amax;
    private elphelvision.EButton Cimax;
    private javax.swing.JPanel ColorModePanel;
    private javax.swing.JPanel ConfirmationPanel;
    private elphelvision.EButton Custom;
    private javax.swing.JPanel FPSPanel;
    private elphelvision.EButton FormatJPEGs;
    private elphelvision.EButton FormatQuicktime;
    private elphelvision.EButton FullHD;
    private elphelvision.EButton JPEGQualityButton;
    private javax.swing.JPanel JPEGQualityPanel;
    private elphelvision.EButton JPEG_Minus;
    private elphelvision.EButton JPEG_Plus;
    ...
    private elphelvision.EButton SettingsOKButton1;
    private elphelvision.EButton SmallHD;
    private elphelvision.EButton WBAuto;
    private elphelvision.EButton WBCloudy;
    private elphelvision.EButton WBCustom;
    private elphelvision.EButton WBDaylight;
    private elphelvision.EButton WBFlourescent;
    private javax.swing.JPanel WBPanel;
    private elphelvision.EButton WBTungsten;
    private javax.swing.JPanel bg;
    private elphelvision.EButton color_jp4;
    private elphelvision.EButton color_rbg;
    private elphelvision.EButton fps24;
    private elphelvision.EButton fps25;
    private elphelvision.EButton fps30;
    private elphelvision.EButton fps50;
    private elphelvision.EButton fps60;
    private elphelvision.EButton fpscustom;
