...
public class EButtonBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_borderColor = 0;
    private static final int PROPERTY_checked = 1;
    private static final int PROPERTY_clickFeedback = 2;
    private static final int PROPERTY_enabled = 3;
    private static final int PROPERTY_font = 4;
    ...
    private static final int PROPERTY_preferredSizeSet = 8;
